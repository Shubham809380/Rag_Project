      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="space-y-8 text-fg-secondary leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-heading mb-3">3. Document Processing</h2>
              <p className="text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-heading mb-3">5. Data Sharing</h2>
              <p className="text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-heading mb-3">6. Data Retention</h2>
              <p className="text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-heading mb-3">7. Changes to This Policy</h2>
              <p className="text-sm">
            ...
            <section>
              <h2 className="text-xl font-bold text-heading mb-3">8. Contact</h2>
              <p className="text-sm">
