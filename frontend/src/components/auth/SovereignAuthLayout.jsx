...
const IndustrialScene = lazy(() => import('../3d/IndustrialCoreScene'));
...
export default function SovereignAuthLayout({ children }) {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--bg-base)' }}>
      {/* Left panel — 3D industrial scene + sovereignty proof */}
      <div className="relative hidden lg:flex flex-col justify-between w-[55%] p-12 overflow-hidden"
        style={{ background: 'linear-gradient(170deg, #070B14 0%, #0A0F1C 55%, #071921 100%)' }}>
