        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="font-bold text-white">InsightRAG</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link to="/signup" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">
                  Get Started
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link to="/privacy" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-sm text-slate-400 hover:text-blue-400 transition-colors">
                  Terms & Conditions
                </Link>
              </li>
            </ul>
